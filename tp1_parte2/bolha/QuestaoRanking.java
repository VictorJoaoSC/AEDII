...
class QuestaoRanking{
    ...
    private static void bubbleSort(){
        ...
        int comparacoes = bubbleSort(n,lista);
    ...
    private static void bubbleSortP(int tam, Time[] lista){
    ...
    private static int bubbleSort(int tam, Time[] lista){
        ...
        for(int i =0; i < tam; i++){
            ...
            for(int j =0; j < tam-1-i;j++){
                if(lista[j].getSaldoGols() >  lista[j+1].getSaldoGols() )
                    swap(j,j+1,lista);
                comparacoes++;
            }
    ...
    private static void criarTxt(long time, int comparacoes){
        String arq_name = "581203_bolha.txt";
