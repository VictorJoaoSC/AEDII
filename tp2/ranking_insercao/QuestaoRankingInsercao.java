...
class QuestaoRankingInsercao{
    ...
    public static int insertionSort(){
        ...
        for(int i = 1; i < n; i++){
            ...
            while( (j>=0) && (lista[j].getVitoria() > temp.getVitoria() ) ){
                lista[j+1] = lista[j];
                j--;
                comparacoes++;
            }            
    ...
    public static void insertionSortP(){
        ...
        for(int i = 1; i < n; i++){
            ...
            while( (j>=0) && lista[j].getPais().compareToIgnoreCase(temp.getPais()) > 0 ){
                lista[j+1] = lista[j];
                j--;
            }            
    ...
    private static void criarTxt(long time, int comparacoes){
        String arq_name = "581203_insercao.txt";
